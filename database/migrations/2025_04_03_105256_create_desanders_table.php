...
return new class extends Migration {
    ...
    {
        Schema::create('desanders', function (Blueprint $table) {
            $table->id('id_desander');
        ...
        // Isi data default setelah create
        DB::table('desanders')->insert([
            'id_wellinfo'        => 1,
            'run_hour'           => 0,
            'feed_rate'          => '0',
            'feed_dens'          => '0',
